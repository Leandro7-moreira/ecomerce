...
} // Fechando a função carregarProdutos
...
document.addEventListener('DOMContentLoaded', function() {
    const produtos = [ 
        ...
        {
            nome: 'Bolsa Magnólia',
            descricao: 'Peça confeccionada em fio de malha com alça versátil em ferragens douradas',
            preco: 319.00,
        ...
        },
        {
            ...
            descricao: 'Peça confeccionada em fio de malha com aba e alça em couro sintético, com base e divisor em acrílico',
            preco: 329.00,
        ...
        {
            nome: 'Bolsa Tiphani',
            descricao: 'Peça confeccionada em fio náutico com fecho da vovó com pérola e ferragens douradas moderna e elegante',
            preco: 299.00,
    ...
    produtos.forEach(produto => {
        ...
        produtoItem.innerHTML = `
            <div class="produto-imagens">
                ...
                <img src="${produto.imagem[0]}" alt="${produto.nome}" class="produto-img">
        ...
        // Lógica para alternar imagens
        const imgElement = produtoItem.querySelector('.produto-img');
        const prevBtn = produtoItem.querySelector('.prev-btn');
        const nextBtn = produtoItem.querySelector('.next-btn');
        let currentImageIndex = 0;

        prevBtn.addEventListener('click', () => {
            currentImageIndex = (currentImageIndex - 1 + produto.imagem.length) % produto.imagem.length;
            imgElement.src = produto.imagem[currentImageIndex];
        });

        nextBtn.addEventListener('click', () => {
            currentImageIndex = (currentImageIndex + 1) % produto.imagem.length;
            imgElement.src = produto.imagem[currentImageIndex];
        });
